...
(function(){
  ...
  btn.type = 'button';
  btn.className = 'breadcrumb-toggle';
  btn.setAttribute('aria-expanded', 'false');
  btn.setAttribute('aria-controls', ol.id || (ol.id = 'breadcrumbList'));
  btn.textContent = "Voir le fil d'Ariane";
  btn.addEventListener('click', function(){
    var open = nav.classList.toggle('is-open');
    btn.setAttribute('aria-expanded', open ? 'true' : 'false');
  });
  nav.querySelector('.container-wide').insertBefore(btn, ol);
})();
